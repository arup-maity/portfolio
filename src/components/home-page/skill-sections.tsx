...
import { AllContent, FrontendContent, BackendContent, DatabaseContent } from "../common/tab-content";
      ...
      <div id="skills" className="container-webx !py-20">
         <div className="mb-5">
            ...
            <p className="w-11/12 lg:w-7/12 text-[15px] text-center mx-auto">
               I specialize in full-stack JavaScript development, covering frontend, backend, and database technologies. Here&apos;s a breakdown of
