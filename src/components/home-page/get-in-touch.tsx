...
const schemaValidation = z.object({
   ...
   subject: z.string().min(4, { message: "This field has to be filled." }),
         ...
         <div className="">
            <div className="container-webx">
               <div className="flex items-center flex-nowrap gap-4 mb-5">
                  <Image src="/bnr-szape03.png" width={40} height={20} alt="" className="!w-auto h-4" />
                  <div className="text-lg text-[#577BFF] font-semibold uppercase tracking-[2px]">Stay Connected</div>
               </div>
               <div className="text-2xl md:text-4xl text-black font-medium mb-10">Let’s Work Together!</div>
            </div>
            <div className="container-webx">
               {/* contact form */}
               <div className="flex items-center flex-wrap -m-10">
                  <div className="w-full md:w-4/12 p-10">
                     <div className="">
                        {/* <div className="flex items-center flex-nowrap gap-4 mb-5">
                        ...
                        <div className="space-y-10">
                           <div className="shaking flex flex-nowrap items-center gap-4">
                              <div className="bg-[#577BFF] text-white inline-flex w-14 h-14 justify-center items-center rounded-full">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16 16" fill="none" className="icon">
                                    <path
                           ...
                           <div className="shaking flex flex-nowrap items-center gap-4">
                              <div className="bg-[#577BFF] text-white inline-flex w-14 h-14 justify-center items-center rounded-full">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 14 18" fill="none" className="icon">
                                    <path
                  ...
                  <div className="w-full md:w-8/12 p-10">
                     <div className="bg-white rounded-2xl px-4 py-10 md:p-10">
                        <form className="flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)}>
                              ...
                              <div className="">
                                 <div className="relative">
                                    <input
                                       ...
                                       id="contact_name"
                                       {...register("fullName")}
                                       className="block px-2.5 pb-2 pt-3 w-full text-base text-gray-600 bg-transparent rounded-xl border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                       placeholder=""
                                    />
                                    <label
                                       htmlFor="contact_name"
                                       className="absolute text-[15px] text-gray-500 duration-300 transform -translate-y-4 scale-90 top-1 z-10 origin-[0] bg-white  px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-90 peer-focus:-translate-y-4 start-1">
                                       Full Name
                                    </label>
                                 </div>
                           ...
                           <div className="">
                              <div className="relative">
                                 ...
                                 <label
                                    htmlFor="message"
                                    className="absolute text-[15px] text-gray-500  duration-300 transform -translate-y-4 scale-90 top-1 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-4 peer-placeholder-shown:top-6 peer-focus:top-1 peer-focus:scale-90 peer-focus:-translate-y-4 start-1">
                                    Message
                                 </label>
                              </div>
                              {errors.message && <p className="text-red-500 text-xs mt-1">{errors.message.message}</p>}
                           </div>
                           <button type="submit" className="bg-[#577BFF] text-base text-white hover:text-white rounded-xl py-2 px-10">
                              Send Message
                           </button>
                        </form>
                     </div>
