                  ...
                  <div className="w-full lg:w-6/12 flex lg:items-center p-4">
                     <div className="">
                        <div className="flex items-center flex-nowrap gap-4 mb-5">
                           ...
                           <div className="text-xl text-theme-color font-semibold uppercase tracking-[2px]">Stay Connected</div>
                        </div>
                        ...
                        <div className="space-y-10">
                           <div className="shaking flex flex-nowrap items-center gap-4">
                              <div className="bg-theme-color text-white inline-flex w-14 h-14 justify-center items-center rounded-full">
                  ...
                  <div className="w-full lg:w-6/12 p-4">
                     <div className="bg-white px-4 py-10 md:p-10">
                        <form className="flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)}>
                           ...
                           <button type="submit" className="bg-theme-color text-base text-white hover:text-white py-3 px-10">
                              Send Message
                           </button>
                        </form>
                     </div>
