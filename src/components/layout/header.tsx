...
const PortfoiloHeader = () => {
   ...
   return (
      <>
                  ...
                  <div className="hidden lg:block">
                     <ul className="flex gap-10">
                        <li className="tracking-[1px]">
                           <Link
                              href="/"
                              className={`${path === "home" ? "text-theme-color" : "text-theme-black"} hover:text-theme-color text-lg font-lato font-semibold`}>
                              Home
                           </Link>
                        </li>
                        <li className="tracking-[1px]">
                        ...
                        <li className="tracking-[1px]">
                           <Link
                              href="/#contact"
                              className={`${path === "contact" ? "text-theme-color" : "text-theme-black"} hover:text-theme-color text-lg font-lato font-semibold`}>
                              Contact
                           </Link>
                        </li>
                     </ul>
         ...
         <div
            className={`fixed top-0 left-0 z-[99999] h-screen p-4 overflow-y-auto transition-transform  bg-white w-80 ${toggledMenu ? "" : "-translate-x-full"}`}>
            <div className="mb-4">
               <div className="">
               ...
               <button
                  type="button"
                  className="text-gray-400 bg-transparent hover:bg-gray-200  rounded-lg  w-8 h-8 absolute top-2.5 end-2.5 flex items-center justify-center"
                  onClick={() => setToggledMenu((prev) => !prev)}>
